import { createRootRoute, Outlet, HeadContent, Scripts, createFileRoute, lazyRouteComponent, RouterProvider, useRouterState, Link, createRouter as createRouter$1 } from '@tanstack/react-router';
...
const appCss = "/assets/app-GcWTw_w2.css";
function cn(...inputs) {
...
function TopNavigationMenu({
  ...
  return /* @__PURE__ */ jsxs(
    NavigationMenuPrimitive.Root,
    {
      ...
      children: [
        children,
        viewport && /* @__PURE__ */ jsx(TopNavigationMenuViewport, {})
      ]
    }
  );
}
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(TopNavigationMenu, { className: "bg-navbar text-navbar-foreground", children: /* @__PURE__ */ jsxs(TopNavigationMenuList, { className: "px-4 space-x-2 w-screen h-12", children: [
    /* @__PURE__ */ jsx(Separator, { orientation: "vertical", className: "bg-neutral-800" }),
    /* @__PURE__ */ jsx(TopNavigationMenuItem, { children: /* @__PURE__ */ jsx(TopNavigationMenuLink, { className: "font-semibold hover:border-transparent", children: /* @__PURE__ */ jsx(Link, { to: "/", children: "crdb.net" }) }) }),
    /* @__PURE__ */ jsx(Separator, { orientation: "vertical", className: "bg-neutral-800" }),
    /* @__PURE__ */ jsx(TopNavigationMenuItem, { children: /* @__PURE__ */ jsx(TopNavigationMenuLink, { className: "", active: inEvents, children: /* @__PURE__ */ jsx(Link, { to: "/events", className: "", children: "Events" }) }) }),
    /* @__PURE__ */ jsx(Separator, { orientation: "vertical", className: "bg-neutral-800" }),
    /* @__PURE__ */ jsx(TopNavigationMenuItem, { children: /* @__PURE__ */ jsx(TopNavigationMenuLink, { className: "", active: inRankings, children: /* @__PURE__ */ jsx(Link, { to: "/rankings", className: "font-display", children: "Rankings" }) }) }),
    /* @__PURE__ */ jsx(Separator, { orientation: "vertical", className: "bg-neutral-800" })
  ] }) }) });
}
...
function RootComponent() {
  return /* @__PURE__ */ jsxs(RootDocument, { children: [
    /* @__PURE__ */ jsx(Navbar, {}),
    /* @__PURE__ */ jsxs("div", { className: "bg-backdrop h-screen flex flex-row", children: [
      /* @__PURE__ */ jsx("div", { className: "w-1/3 max-w-1/5" }),
      /* @__PURE__ */ jsx("div", { className: "grow bg-page", children: /* @__PURE__ */ jsx(Outlet, {}) }),
      /* @__PURE__ */ jsx("div", { className: "w-1/3 max-w-1/5" })
    ] })
  ] });
}
...
const $$splitComponentImporter$7 = () => import('./rankings-DGIuyp9b.mjs');
const Route$7 = createFileRoute("/rankings")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import('./index-BVnwk-Rd.mjs');
const Route$6 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import('./index-h-PIiIsp.mjs');
...
const $$splitComponentImporter$3 = () => import('./demo.index-ByNCfBvL.mjs');
const Route$3 = createFileRoute("/events/demo/")({
...
const $$splitComponentImporter = () => import('./demo.brackets-CviYcTz1.mjs');
const Route = createFileRoute("/events/demo/brackets")({
...
const EventsIndexRoute = Route$5.update({
  id: "/events/",
  path: "/events/",
  getParentRoute: () => Route$8
});
const EventsDemoRoute = Route$4.update({
  id: "/events/demo",
  path: "/events/demo",
  getParentRoute: () => Route$8
});
const EventsDemoIndexRoute = Route$3.update({
  id: "/",
  path: "/",
  getParentRoute: () => EventsDemoRoute
});
const EventsDemoUpcomingRoute = Route$2.update({
  id: "/upcoming",
  path: "/upcoming",
  getParentRoute: () => EventsDemoRoute
});
const EventsDemoEntriesRoute = Route$1.update({
  id: "/entries",
  path: "/entries",
  getParentRoute: () => EventsDemoRoute
});
const EventsDemoBracketsRoute = Route.update({
  id: "/brackets",
  path: "/brackets",
  getParentRoute: () => EventsDemoRoute
});
const EventsDemoRouteChildren = {
  EventsDemoBracketsRoute,
  EventsDemoEntriesRoute,
  EventsDemoUpcomingRoute,
  EventsDemoIndexRoute
};
...
export { Separator as S, cn as c, serverEntry as default };
